...
<body> 
    ...
    $which_test = $_SESSION["which_test"];
    ?>

    <h4 onclick="location.href='main.php'" style="margin-left:10px; margin-top:10px; margin-botton:0px; height:10px; padding:0px; float:left;"><?php echo "<div style='float:left;'>$which_test</div>"; ?>  게시판</h4>
